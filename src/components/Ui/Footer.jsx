...
const Footer = () => {
  return (
    <div className="w-full bg-[#1D2026] p-4 pt-20">
      <div className="max-w-[1200px] mx-auto flex items-center justify-between">
        <div>
          <h1 className="text-[#FFFFFF] text-3xl font-[600] w-[450px]">
            Start learning with 67.1k students around the world.
          </h1>
          <div className="flex items-center gap-5 mt-4 ">
            <Button
              style={
                "text-[#fff] font-[500] px-6 py-3 bg-[#FF6636]  rounded-sm"
              }
              text={"Join the Family  "}
            />
            <Button
              style={
                "text-[#fff] font-[500] px-6 py-3 bg-[#363B47]  rounded-sm"
              }
        ...
        <div className="flex items-center gap-20 justify-between">
          <div>
            <h1 className="font-[600] text-4xl text-white ">6.3k</h1>
            <p className="text-[#B7BAC7] pt-2">Online courses</p>
          </div>
          <div>
            <h1 className="font-[600] text-4xl text-white ">26kk</h1>
            <p className="text-[#B7BAC7] pt-2">Certified Instructor</p>
          </div>
          <div>
            <h1 className="font-[600] text-4xl text-white ">99.9%</h1>
            <p className="text-[#B7BAC7] pt-2">Sucess Rate</p>
          </div>
        </div>
      </div>
      <div className="max-w-[1200px] mx-auto flex items-center justify-between mt-30 pb-20">
        <div>
          <img src={whitelogo} />
