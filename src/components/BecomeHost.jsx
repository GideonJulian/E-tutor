...
const BecomeHost = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center gap-10 px-4 py-8">
      ...
      <div className="block lg:hidden w-full rounded-xl p-6 text-white" style={{
      ...
      <div className="relative w-full max-w-[570px] hidden lg:block">
        <img src={become} alt="Become instructor" className="w-full h-auto rounded-md" />
      ...
      <div className="w-full max-w-[640px] bg-white rounded-lg p-6 shadow-md">
        <h1 className="font-semibold text-lg md:text-xl">Your teaching & earning steps</h1>
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
          {[
            ...
            <div key={index} className="flex items-center gap-3">
              <img src={items.icon} className="w-[48px] h-[48px]" alt={`step-${index + 1}`} />
